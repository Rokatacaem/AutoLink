...
# Migrations are removed from startup to prevent Vercel Serverless timeouts and race conditions.
# Migrations should be executed manually via CLI or CI/CD pipelines.
